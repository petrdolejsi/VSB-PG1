...
/* raytracer mainloop */
int allied_avenger( const std::string file_name, const char * config )
{
...
int allied_avenger_bigger(const std::string file_name, const char * config)
{
	//SimpleGuiDX11 gui( 640, 480 );
	//gui.MainLoop();

	Raytracer raytracer(1000, 750, deg2rad(45.0), Vector3(175, -140, 130), Vector3(0, 0, 35), config);
	raytracer.width_ = 1000;
	raytracer.height_ = 750;
	raytracer.LoadScene(file_name);
	raytracer.MainLoop();
...
int sphere(const std::string file_name, const char * config)
{
	//SimpleGuiDX11 gui( 640, 480 );
	//gui.MainLoop();

	Raytracer raytracer(640, 480, deg2rad(45.0), Vector3(4, 0, 0), Vector3(0, 0, 0), config);
	raytracer.width_ = 640;
	raytracer.height_ = 480;
	raytracer.LoadScene(file_name);
	raytracer.MainLoop();
...
int box(const std::string file_name, const char * config)
{
	//SimpleGuiDX11 gui( 640, 480 );
	//gui.MainLoop();

	//Raytracer raytracer(640, 480, deg2rad(40.0), Vector3(40, -940, 250), Vector3(0, 0, 250), config);
	Raytracer raytracer(640, 480, deg2rad(40.0), Vector3(0, -940, 250), Vector3(0, 0, 250), config);
	raytracer.background = false;
	raytracer.width_ = 640;
	raytracer.height_ = 480;
	raytracer.LoadScene(file_name);
	raytracer.MainLoop();
